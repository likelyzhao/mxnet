...
from ..core.loader import AnchorLoaderAddcls
from ..core.module import MutableModule
from ..utils.load_data import load_gt_roidb, merge_roidb, filter_roidb
from ..utils.load_model import load_param


def train_rpn_mutiltask(network, dataset, image_set, root_path, dataset_path,
    ...
    # load training data
    train_data = AnchorLoaderAddcls(feat_sym, roidb, batch_size=input_batch_size, shuffle=not no_shuffle,
...
#        arg_params, aux_params = load_param(pretrained, epoch, convert=True)
    ...
    clsacc_metric = metric.MutilTaskAccMetric()
    eval_metrics = mx.metric.CompositeEvalMetric()
    for child_metric in [eval_metric, cls_metric, bbox_metric,clsacc_metric]:
...
def main():
    ...
    train_rpn_mutiltask(args.network, args.dataset, args.image_set, args.root_path, args.dataset_path,
